...
public class CategoryService implements InterfaceCategoryService {
    ...
    public void editCategory(Integer user_id, Integer category_id, CategoryProduct category) {
        ...
        if (repeatedCategory != null && !repeatedCategory.getUser_id().equals(user_id)) throw new CustomException(HttpStatus.UNPROCESSABLE_ENTITY, "Este nombre ya está siendo utilizado en otra categoría");
    ...
    public void deleteCategory(Integer user_id, Integer category_id) {
        ...
        if (!products.isEmpty()) throw  new CustomException(HttpStatus.UNPROCESSABLE_ENTITY, "No se puede borrar esta categoría porque hay productos asociados a esta");
